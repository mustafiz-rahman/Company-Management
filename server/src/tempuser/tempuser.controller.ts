...
export class TempuserController {
    constructor(private teampuserservice:TempuserService,private userService:UserService){}
    ...
    @Post('/tempuser/:token')
    async tempuserLogin(@Param('token') token:string,@Body() body:GetTempuserDto, ){
